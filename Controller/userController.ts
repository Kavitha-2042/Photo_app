...
export const Signup = (req:ModifiedRequest, res:express.Response, next:express.NextFunction) =>{
    ...
    .then((validateResponse)=>{
        ...
        .then((emailResponse)=>{
            ...
            if(conpassword !== password){
                return res.json({message:"Confirm Password doesn't match with Password"})
            }
    ...
    .then((validateResponse)=>{
        ...
        .then((emailResponse)=>{
            ...
            .then((comparingResult)=>{
                ...
                let token = jwt.sign({_id:String(emailResponse._id)}, process.env.SECRET_KEY as string)
...
export const Status = (req:ModifiedRequest, res:express.Response,next:express.NextFunction) =>{
    if(!req.users){
...
export const ImageUpload =(req:ModifiedRequest,res:express.Response) =>{
    console.log("Image result: ",req.file)
